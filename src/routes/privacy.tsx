...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy — Vortex Footwear" },
      { name: "description", content: "Vortex Footwear privacy notice." },
    ],
  }),
  component: Privacy,
});
  ...
  return (
    <div className="container-page py-16 md:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-6 text-xs text-muted-foreground">This page is maintained by Vortex Footwear.</p>
